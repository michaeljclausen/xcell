...
describe('array-util', () => {
  ...
  describe('getRange()', () => {
    ...
    it('produces a valid negative range starting with -10', () => {
  ...
  describe('getLetterRange()', () => {
    ...
    it('produces a valid single letter range starting with A.', () => {
      expect(getLetterRange('A', 5)).toEqual(['A', 'B', 'C', 'D', 'E']);
    });

    it('produces a valid single letter range starting with B.', () => {
